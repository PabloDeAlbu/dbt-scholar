...
WITH seed_base AS (
    SELECT
        ...
        titulo_completo::text AS title_raw,
        autor_100a::text AS author_raw,
        serie::text AS type_raw,
...
prepared AS (
    ...
    LEFT JOIN {{ ref('dim_unlp_seed_14365_input_type') }} AS type_map
      ON type_map.source_name = 'seed_libros'
