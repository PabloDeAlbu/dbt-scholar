{% set field_relation = source('vocsedici', 'node__field_researchgate') %}
{% if execute %}
...
renamed as (
  select
    ...
    {{ safe_cast(field_relation, 'field_researchgate_value', 'text', alias='researchgate', col_names=field_col_names, default_mode='ghost') }},
...
casted as (
  select
    ...
    researchgate::text as researchgate,
