{% set field_relation = source('vocsedici', 'node__field_mail') %}
{% if execute %}
...
renamed as (
  select
    ...
    {{ safe_cast(field_relation, 'field_mail_value', 'text', alias='email', col_names=field_col_names, default_mode='ghost') }},
