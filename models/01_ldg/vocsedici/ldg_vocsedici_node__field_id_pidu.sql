{% set field_relation = source('vocsedici', 'node__field_id_pidu') %}
{% if execute %}
...
renamed as (
  select
    ...
    {{ safe_cast(field_relation, 'field_id_pidu_value', 'text', alias='pidu_id', col_names=field_col_names, default_mode='ghost') }},
