{% set field_relation = source('vocsedici', 'paragraph__field_persona_id') %}
{% if execute %}
...
renamed as (
  select
    ...
    {{ safe_cast(field_relation, 'field_persona_id_value', 'bigint', alias='persona_node_id', col_names=field_col_names, default_mode='ghost') }},
...
casted as (
  select
    ...
    persona_node_id::bigint as persona_node_id,
