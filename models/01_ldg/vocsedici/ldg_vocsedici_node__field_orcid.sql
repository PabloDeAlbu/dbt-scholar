{% set field_relation = source('vocsedici', 'node__field_orcid') %}
{% if execute %}
...
renamed as (
  select
    ...
    {{ safe_cast(field_relation, 'field_orcid_value', 'text', alias='orcid', col_names=field_col_names, default_mode='ghost') }},
