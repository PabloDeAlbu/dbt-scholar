{% set field_relation = source('vocsedici', 'paragraph__field_fecha_inicio') %}
{% if execute %}
...
renamed as (
  select
    ...
    {{ safe_cast(field_relation, 'field_fecha_inicio_value', 'date', alias='fecha_inicio', col_names=field_col_names, default_mode='ghost') }},
...
ghost_record as (
  select
    ...
    -1::int as delta,
    '1900-01-01'::date as fecha_inicio,
