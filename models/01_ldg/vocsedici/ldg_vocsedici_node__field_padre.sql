{% set field_relation = source('vocsedici', 'node__field_padre') %}
{% if execute %}
...
renamed as (
  select
    ...
    {{ safe_cast(field_relation, 'field_padre_target_id', 'bigint', alias='parent_institution_node_id', col_names=field_col_names, default_mode='ghost') }},
...
casted as (
  select
    ...
    parent_institution_node_id::bigint as parent_institution_node_id,
