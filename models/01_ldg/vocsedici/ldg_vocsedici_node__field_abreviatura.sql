{% set field_relation = source('vocsedici', 'node__field_abreviatura') %}
{% if execute %}
...
renamed as (
  select
    ...
    {{ safe_cast(field_relation, 'field_abreviatura_value', 'text', alias='abbreviation', col_names=field_col_names, default_mode='ghost') }},
