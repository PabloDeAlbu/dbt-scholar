{% set field_relation = source('vocsedici', 'node__field_nombre') %}
{% if execute %}
...
renamed as (
  select
    ...
    {{ safe_cast(field_relation, 'field_nombre_value', 'text', alias='nombre', col_names=field_col_names, default_mode='ghost') }},
