...
WITH base AS (
    SELECT 
        ...
        lnk_com_com_6.parent_comm_hk as com_6_hk,
        lnk_com_com_5.parent_comm_hk as com_5_hk,
        lnk_com_com_4.parent_comm_hk as com_4_hk,
        lnk_com_com_3.parent_comm_hk as com_3_hk,
        lnk_com_com_2.parent_comm_hk as com_2_hk,
        lnk_com_com_1.parent_comm_hk as com_1_hk
    FROM {{ref('link_dspace5_community_collection')}} lnk_com_col
    INNER JOIN {{ref('link_dspace5_community_community')}} lnk_com_com_6 ON
        lnk_com_col.community_hk = lnk_com_com_6.child_comm_hk
    LEFT JOIN {{ref('link_dspace5_community_community')}} lnk_com_com_5 ON
        lnk_com_com_6.parent_comm_hk = lnk_com_com_5.child_comm_hk
    LEFT JOIN {{ref('link_dspace5_community_community')}} lnk_com_com_4 ON
        lnk_com_com_5.parent_comm_hk = lnk_com_com_4.child_comm_hk
    LEFT JOIN {{ref('link_dspace5_community_community')}} lnk_com_com_3 ON
        lnk_com_com_4.parent_comm_hk = lnk_com_com_3.child_comm_hk
    LEFT JOIN {{ref('link_dspace5_community_community')}} lnk_com_com_2 ON
        lnk_com_com_3.parent_comm_hk = lnk_com_com_2.child_comm_hk
    LEFT JOIN {{ref('link_dspace5_community_community')}} lnk_com_com_1 ON
        lnk_com_com_2.parent_comm_hk = lnk_com_com_1.child_comm_hk
),
